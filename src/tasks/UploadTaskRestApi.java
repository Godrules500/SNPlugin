...
public class UploadTaskRestApi implements Runnable
{
    ...
    public UploadTaskRestApi(Project project, VirtualFile[] files, serviceNow.SNClient SNClient, ProjectSettingsController projectSettingsController)
    {
